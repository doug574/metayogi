 ...
 */
class RelationPlugin implements PluginInterface
{
    /** Entity ID for this component in the Components collection */
    protected static $uuid = '5070bb890de404f00d0000c5';

    /** Files of entities installed/uninstalled with this component */
    protected static $datafiles = array('rdf:properties', 'rdfs:classes' /*'my:routes', 'my:views', 'my:controllers', 'my:rbacs'*/);
